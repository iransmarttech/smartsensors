...
// Network Credentials
// =============================================================================
const char* WIFI_SSID = "Morteza";//iran-smarttech
const char* WIFI_PASS = "miopmiow";//Hh3040650051@
...
struct SMSSettings {
    ...
    String soap_url = "http://www.linepayamak.ir/Post/Send.asmx?wsdl";
    String custom_message = "Alert: ";
    bool enabled = true;
};
...
<body>
  <div class="container">
    ...
    client.print(R"=====(">
          ...
          <!-- New fields for SOAP URL and Custom Message -->
          <div class="form-group">
            <label for="sms_soap_url">SOAP URL</label>
            <input type="text" id="sms_soap_url" name="sms_soap_url" value=")=====");
    client.print(thresholds.sms.soap_url);
    client.print(R"=====(">
          </div>
          <div class="form-group">
            <label for="sms_custom_message">Custom Alert Message</label>
            <input type="text" id="sms_custom_message" name="sms_custom_message" value=")=====");
    client.print(thresholds.sms.custom_message);
    client.print(R"=====(">
          </div>
        </div>
...
void sendSMSAlert(const String& message) {
    ...
    // Combine custom message with the specific alert message
    String fullMessage = thresholds.sms.custom_message + "\n" + message;
    ...
    <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" 
      ...
      <soapenv:Body>
        <tem:SendSimpleSMS>
          ...
          <tem:text>)" + fullMessage + R"(</tem:text>
...
void saveSettings() {
    ...
    preferences.putString("sms_soap_url", thresholds.sms.soap_url); 
    preferences.putString("sms_custom_message", thresholds.sms.custom_message); 
...
void loadSettings() {
    ...
    thresholds.sms.soap_url = preferences.getString("sms_soap_url", "http://www.linepayamak.ir/Post/Send.asmx?wsdl");
    thresholds.sms.custom_message = preferences.getString("sms_custom_message", "Alert: ");
...
void handleSettingsUpdate(Client &client, String request) {
    ...
    thresholds.sms.soap_url = getValue(postData, "sms_soap_url=");
    thresholds.sms.custom_message = getValue(postData, "sms_custom_message=");
